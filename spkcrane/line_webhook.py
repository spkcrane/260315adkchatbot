...
from crane_lead_pipeline.agent import root_agent
...
if not CHANNEL_SECRET or CHANNEL_SECRET == "YOUR_CHANNEL_SECRET":
    print("WARNING: CHANNEL_SECRET is not configured. LINE webhook will not work.")

APP_NAME = "spkcrane_lead_app"
...
if CHANNEL_SECRET and CHANNEL_SECRET != "YOUR_CHANNEL_SECRET":
...
def root():
    return {"status": "ok", "message": "SPKCrane Lead Bot is running"}


if __name__ == "__main__":
    # Cloud Run injects PORT env var; default 8080 for Cloud Run, 8000 for local dev
